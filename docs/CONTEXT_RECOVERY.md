...
- **Cập nhật 07/07/2026 - workflow build mới bước 1:** theo chốt mới từ anh/khách, build sẽ chuyển dần sang kiểu nhân vật đứng camera thường, ô ngay trước mũi chân phát viền trắng theo hướng mặt nhân vật; không chuyển camera top-down và không kéo ghost tự do như build mode cũ. Đã thêm `FrontBuildCellSelector` runtime để chọn `BuildSurfaceCell` phía trước người chơi và vẽ viền trắng trên mặt ô. **Chưa làm:** chuyển nút búa xuống tay phải, mở build list cũ không đổi camera, ghost preview cố định tại ô trước mặt, confirm đặt công trình. **Cần test:** Editor/APK xác nhận viền trắng bám đúng ô trước chân khi xoay/di chuyển.
