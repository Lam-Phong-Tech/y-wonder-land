...
namespace YWonderLand.Environment
{
    public class ResourceSpawner : MonoBehaviour
    {
        ...
        private Vector3 GetRandomPosition()
        {
            ...
            // Cộng thêm transform.position để tâm sinh tài nguyên đi theo vị trí của Spawner trên Scene
            return transform.position + spawnCenter + new Vector3(rand.x, 0, rand.y);
        }
