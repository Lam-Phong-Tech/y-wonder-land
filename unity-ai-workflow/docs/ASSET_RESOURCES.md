...
Backend packages for live-ops, social, and analytics. Managed via [UGS Dashboard](https://cloud.unity.com/). Compatible with Unity 2022 LTS.

| Package | Purpose | Notes |
|---------|---------|-------|
| [`com.unity.services.authentication`](https://docs.unity.com/ugs/en-us/manual/authentication/manual) | Sign in/up (anonymous, platform, email) | Required for all other UGS services |
| [`com.unity.services.cloudsave`](https://docs.unity.com/ugs/en-us/manual/cloud-save/manual) | Player data persistence | Key-value store; replaces manual save backends |
| [`com.unity.services.economy`](https://docs.unity.com/ugs/en-us/manual/economy/manual) | Virtual currencies & items | Balances, inventories, store purchases |
| [`com.unity.services.leaderboards`](https://docs.unity.com/ugs/en-us/manual/leaderboards/manual) | Rankings | Bucketed, tiered, or global leaderboards |
| [`com.unity.services.friends`](https://docs.unity.com/ugs/en-us/manual/friends/manual) | Social features | Friend lists, presence, relationships |
| [`com.unity.services.lobby`](https://docs.unity.com/ugs/en-us/manual/lobby/manual) | Room management | Create/join/query lobbies; relay-compatible |
| [`com.unity.services.analytics`](https://docs.unity.com/ugs/en-us/manual/analytics/manual) | Player behavior tracking | Custom events, funnels, data export |
| [`com.unity.services.push-notifications`](https://docs.unity.com/ugs/en-us/manual/push-notifications/manual) | Push alerts | Campaigns, segments, scheduled sends |

> All UGS calls are async. Use `UniTask` for zero-allocation awaiting — see Gameplay & Architecture section below.
...
| [UniTask](https://github.com/Cysharp/UniTask) | Zero-allocation async/await for Unity | Free; **primary async solution** for Unity 2022 LTS (replaces `Awaitable` which is Unity 6+ only) |
