...
| **UGS Authentication integration** | `TDD` (network section), `API_CONTRACTS.md` | Network Engineer | `network-setup` |
| **Cloud Save / Economy** | `GDD`, `TDD`, `DATA_SCHEMA.md` | Gameplay Dev | `scriptable-object-arch` |
| **UI Toolkit layout** | `TDD` (UI section), `GFD`, `DESIGN.md` | UI Specialist | `ui-toolkit-binder` |
