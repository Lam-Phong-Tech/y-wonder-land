...
- `[~]` **Kết quả runtime 14/07 - chưa đạt:** EXE trồng/tưới nhưng APK cùng account `Thu2026` vẫn thấy snapshot cũ/thiếu cây. Logout -> relogin nhanh trong cùng tiến trình EXE/APK không làm hai phiên đá nhau; chỉ khi đóng hẳn app rồi mở lại mới thấy rule `4008` hoạt động. Không tick hoàn thành đồng bộ farm hoặc phiên đơn.
