...
- `[~]` Yêu cầu mới của khách: bỏ tâm/crosshair cho tương tác cây, hồ nước, tảng đá, chuồng/cửa hàng; đã code flow tap/click trực tiếp lên vật thể trong tầm khoảng 1-2m để hiện UI action, chờ anh build APK/EXE test.
