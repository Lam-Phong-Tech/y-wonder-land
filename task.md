...
- `[~]` Public cutover còn lại: `root/password` vẫn giữ để rollback; cần hardening auth/rate-limit/log trước khi public, xác nhận quyền đổi DNS và dependency web cũ trên `api.ywonder.net`, đổi Caddy sang domain HTTPS/WSS, mở đúng `80/443`, test ngoài mạng và reboot smoke. Tuyệt đối không public `3000/5432/8080`.
